...
public class ModFluidTypes {
	...
	public static final RegistryObject<FluidType> MUD = FLUID_TYPES.register("mud", () -> new MudFluidType(FluidType.Properties.create().canExtinguish(true).fallDistanceModifier(0F).supportsBoating(true)));
}
