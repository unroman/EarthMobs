...
public class ModBiomeModifiers {
	...
	public static final RegistryObject<Codec<EarthBiomeModifier>> EARTH_ENTITY_MODIFIER_TYPE = BIOME_MODIFIER_SERIALIZERS.register("earth_entity_modifier", EarthBiomeModifier::makeCodec);
