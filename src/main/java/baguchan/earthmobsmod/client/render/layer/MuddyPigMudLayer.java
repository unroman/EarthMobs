		...
		if (pig instanceof IMuddy && pig instanceof ISheared) {
			if (((IMuddy) pig).isMuddy()) {
				if (pig.isInvisible()) {
					...
					coloredCutoutModelCopyLayerRender(this.getParentModel(), this.model, MUD_LOCATION, p_117421_, p_117422_, p_117423_, pig, p_117425_, p_117426_, p_117428_, p_117429_, p_117430_, p_117427_, f, f1, f2);
				}
			} else {
				if (pig.isInvisible()) {
					Minecraft minecraft = Minecraft.getInstance();
