...
public class WoolyCowModel<T extends WoolyCow> extends CowModel<T> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition partdefinition3 = partdefinition2.addOrReplaceChild("body_part", CubeListBuilder.create().texOffs(52, 6).addBox(-42.0F, -1.5F, 30.0F, 3F, 8.0F, 0.0F), PartPose.offsetAndRotation(2.5F, 20.0F, 32.0F, ((float)Math.PI / 2F), -((float)Math.PI / 2F), 0.0F));
		partdefinition3.addOrReplaceChild("body_part2", CubeListBuilder.create().texOffs(52, 6).addBox(-1.5F, -4.0F, 0.0F, 3F, 8.0F, 0.0F), PartPose.offsetAndRotation(-40.0F, 2.5F, 12.0F, ((float)Math.PI), 0.0F, 0.0F));

		PartDefinition partdefinition4 = partdefinition2.addOrReplaceChild("body_part", CubeListBuilder.create().texOffs(26, 0).addBox(1.0F, -0.01F, -2.0F, 16.0F, 0.0F, 3.0F), PartPose.offsetAndRotation(6.0F, -10.0F, -8.0F, 0.0F, 0.0F, ((float)Math.PI / 2F)));
		partdefinition4.addOrReplaceChild("body_part2", CubeListBuilder.create().texOffs(26, 0).addBox(-8.0F, 0.0F, -1.5F, 16.0F, 8.0F, 3.0F), PartPose.offsetAndRotation(9.0F, 12.01F, -0.5F, 0.0F, 0.0F, -((float)Math.PI)));
