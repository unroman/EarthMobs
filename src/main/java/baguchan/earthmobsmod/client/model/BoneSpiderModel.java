...
public class BoneSpiderModel<T extends BoneSpider> extends SpiderModel<T> {
	...
	public static LayerDefinition createSpiderBodyLayer() {
		...
		int i = 15;
		partdefinition.addOrReplaceChild("head", CubeListBuilder.create().texOffs(32, 4).addBox(-4.0F, -4.0F, -8.0F, 8.0F, 9.0F, 8.0F).texOffs(0, 28).addBox(-4.0F, -4.0F, -8.0F, 8.0F, 8.0F, 8.0F), PartPose.offset(0.0F, 15.0F, -3.0F));
